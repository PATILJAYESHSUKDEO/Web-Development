	  ...
	  <nav class="navbar navbar-expand-lg navbar-light">
		...
		<div class="collapse navbar-collapse" id="navigation">
		  <ul class="navbar-nav ml-auto text-center">
			...
			<li class="nav-item ">
			  <a class="nav-link" href="service.html">HISTORY</a>
			</li>
			<li class="nav-item ">
			  <a class="nav-link" href="portfolio.html">ART&CULTURE</a>
			</li>
			<li class="nav-item ">
			  <a class="nav-link" href="team.html">GALLERY</a>
			</li>
			<li class="nav-item ">
			  <a class="nav-link" href="pricing.html">VIDEOS</a>
			</li>
			<li class="nav-item ">
